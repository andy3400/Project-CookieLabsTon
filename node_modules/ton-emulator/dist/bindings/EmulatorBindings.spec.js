...
describe('EmulatorBindings', () => {
    it('should create bindings', async () => {
        let code = ton_core_1.Cell.fromBoc(Buffer.from(echoCode, 'base64'))[0];
        ...
        let res = await bindings.runGetMethod({
            ...
            code,
            data,
            address: (0, ton_core_1.contractAddress)(0, { code, data }),
    ...
    it('should execute emulator case', async () => {
        ...
        let res = await bindings.runGetMethod({
            ...
            methodId: 93099,
            args: [],
            config: ton_core_1.Cell.fromBase64('')
        });
