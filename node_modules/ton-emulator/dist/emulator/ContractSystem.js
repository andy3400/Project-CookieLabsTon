...
var _ContractSystem_instances, _ContractSystem_config, _ContractSystem_now, _ContractSystem_lt, _ContractSystem_bindings, _ContractSystem_contracts, _ContractSystem_abis, _ContractSystem_pending, _ContractSystem_trackers, _ContractSystem_loggers, _ContractSystem_send, _ContractSystem_provider;
...
class ContractSystem {
    ...
    treasure(seed, workchain = 0) {
        ...
        this.contract(treasure.address).balance = (0, ton_core_1.toNano)(1000000);
        // Return sender
    ...
    contract(contract) {
        ...
        if (!executor) {
            executor = ContractExecutor_1.ContractExecutor.createEmpty(contract, this);
...
_ContractSystem_config = new WeakMap(), _ContractSystem_now = new WeakMap(), _ContractSystem_lt = new WeakMap(), _ContractSystem_bindings = new WeakMap(), _ContractSystem_contracts = new WeakMap(), _ContractSystem_abis = new WeakMap(), _ContractSystem_pending = new WeakMap(), _ContractSystem_trackers = new WeakMap(), _ContractSystem_loggers = new WeakMap(), _ContractSystem_send = new WeakMap(), _ContractSystem_instances = new WeakSet(), _ContractSystem_provider = function _ContractSystem_provider(address, init) {
